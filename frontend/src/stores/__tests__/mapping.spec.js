...
describe('Mapping Store', () => {
  ...
  describe('Computed Properties', () => {
    ...
    it('should compute sourceFields correctly', () => {
      ...
      expect(store.sourceFields).toEqual([
        ...
        { name: 'name', type: 'varchar', id: 'name', type: 'varchar' }
      ])
    })
    ...
    it('should compute targetFields correctly', () => {
      ...
      expect(store.targetFields).toEqual([
        ...
        { name: 'user_name', type: 'text', id: 'user_name', type: 'text' }
      ])
    })
    ...
    it('should compute filteredMappings correctly', () => {
      store.mappings = [
        { id: 1, name: 'User Mapping', type: 'batch', isActive: true, tags: ['user'] },
        { id: 2, name: 'Product Sync', type: 'realtime', isActive: false, tags: ['product'] },
        { id: 3, name: 'Order Processing', type: 'batch', isActive: true, tags: ['order', 'user'] }
      ]
  ...
  describe('Actions - Mapping CRUD', () => {
    ...
    describe('createMapping', () => {
      it('should create mapping successfully', async () => {
        ...
        mappingService.createMapping.mockResolvedValue({ data: createdMapping })
      ...
      it('should handle create error', async () => {
        ...
        await expect(store.createMapping({})).rejects.toThrow('Validation error')
    ...
    describe('updateMapping', () => {
      it('should update mapping successfully', async () => {
        ...
        mappingService.updateMapping.mockResolvedValue({ data: updatedMapping })
  ...
  describe('Actions - Mapping Operations', () => {
    describe('executeMapping', () => {
      it('should execute mapping successfully', async () => {
        ...
        mappingService.executeMapping.mockResolvedValue({ data: executionResult })
        
        const result = await store.executeMapping(1, { mode: 'batch' })
        
        expect(mappingService.executeMapping).toHaveBeenCalledWith(1, { mode: 'batch' })
    ...
    describe('validateMapping', () => {
      it('should validate mapping successfully', async () => {
        ...
        mappingService.validateMapping.mockResolvedValue({ data: validationResult })
    ...
    describe('previewMapping', () => {
      it('should preview mapping successfully', async () => {
        ...
        mappingService.previewMapping.mockResolvedValue({ data: previewResult })
        
        const result = await store.previewMapping(1, { sample: [{ id: 1 }] })
        
        expect(mappingService.previewMapping).toHaveBeenCalledWith(1, { sample: [{ id: 1 }] })
  ...
  describe('Actions - Field Mappings', () => {
    it('should add field mapping', () => {
      ...
      const mapping = store.addFieldMapping(sourceField, targetField, transformations)
    ...
    it('should update field mapping', () => {
      // Add initial mapping
      const mapping = store.addFieldMapping({ name: 'id' }, { name: 'user_id' })
      ...
      const updatedMapping = store.fieldMappings.find(m => m.id === mappingId)
    ...
    it('should remove field mapping', () => {
      // Add two mappings
      const mapping1 = store.addFieldMapping({ name: 'id' }, { name: 'user_id' })
      const mapping2 = store.addFieldMapping({ name: 'name' }, { name: 'user_name' })
  ...
  describe('Actions - Metadata', () => {
    ...
    it('should fetch execution history', async () => {
      ...
      expect(mappingService.getMappingExecutionHistory).toHaveBeenCalledWith(1, { limit: 10 })
